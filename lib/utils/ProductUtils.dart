...
class ProductUtils {
  static singleProductItemOption(ProductItem productItem, ThemeData? themeData,
    ...
    for (int i = 0; i < productItemFeatures.length; i++) {
      ...
      } else if (productItemFeature.feature.toLowerCase().compareTo('size') ==
          0) {
        _list.add(Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: customAppTheme!.bgLayer4, width: 1.6),
      ...
      } else if (productItemFeature.feature.toLowerCase().compareTo('gram') ==
          0) {
        _list.add(Container(
